...
namespace calcs
{
    ...
    inline int addition(int first, int second, int *result)
    {
    ...
    inline int subtraction(int first, int second, int *result)
    {
    ...
    inline int division(int first, int second, int *result)
    {
        if (second == 0)
        {
    ...
    inline int multiplication(int first, int second, int *result)
    {
    ...
    inline int factorial(int first, int *result)
    {
        if (first < 0)
        {
    ...
    inline int power(int first, int second, int *result)
    {
        if (second < 0)
        {
